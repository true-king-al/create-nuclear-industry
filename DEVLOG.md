...
- **Boiler** — with its steam tank full it kept using water and throwing the steam away, and it kept cooling the reactor while not boiling. It now boils only what the steam tank has room for, and only cools the reactor while actually boiling
